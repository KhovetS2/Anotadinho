...
//! `chrono` deliberadamente (ver `crates/core`), então tudo aqui usa
//! aritmética inteira sobre o número de dia juliano (JDN), que lida com
//! virada de mês/ano/bissexto sem casos especiais.
