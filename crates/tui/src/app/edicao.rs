...
pub(super) fn aplicar_detalhe(e: &mut Estado, alvo: &super::modais::AlvoDoDetalhe, form: &mut crate::componentes::Formulario) {
    ...
    match alvo {
        ...
        AlvoDoDetalhe::Agente | AlvoDoDetalhe::Teclas | AlvoDoDetalhe::Imagem | AlvoDoDetalhe::Permissoes | AlvoDoDetalhe::PropostaEditada { .. } => {}
...
pub(super) fn excluir_do_detalhe(e: &mut Estado, alvo: &super::modais::AlvoDoDetalhe) {
    ...
    match alvo {
        ...
        AlvoDoDetalhe::Propriedades | AlvoDoDetalhe::Consulta { .. } | AlvoDoDetalhe::Agente | AlvoDoDetalhe::Teclas | AlvoDoDetalhe::Imagem | AlvoDoDetalhe::Permissoes | AlvoDoDetalhe::PropostaEditada { .. } | AlvoDoDetalhe::TabelaMd { .. } => {}
        AlvoDoDetalhe::Barra { embed, indice } => {
            let i = *indice;
            if editar_cronograma(e, embed, |d| {
                d.items.remove(i);
